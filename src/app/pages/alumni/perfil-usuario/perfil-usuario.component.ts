...
export class PerfilUsuarioComponent implements OnInit {
  ...
  constructor(private graduadoService: GraduadoService, private personaService: PersonaService,
  ...
  buscarGraduadosPorUsuario() {
    this.graduadoService.searchGraduadosByUsuario(this.usuarioGuardado).subscribe(
      graduadosEncontrados => {
        ...
        this.usuarioService.getUsuarioByUsername(this.usuarioGuardado).subscribe(res => {
          this.user = res;
          this.person = this.user.persona;
        })
      }
    );
  }
